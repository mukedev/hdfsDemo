 ...
 * @date 2020/6/13
 */
public class NextMutualFriendApp {

    public static void main(String[] args) throws URISyntaxException, IOException, ClassNotFoundException, InterruptedException {

        String inPath = "hdfs://had-node:8020/friends/output";
        String outPath = "hdfs://had-node:8020/friends/output2";
        ...
        //获取job实例并设置主类
        Job job = Job.getInstance(conf, "next_mutualFriend_test");
        job.setJarByClass(NextMutualFriendApp.class);
        ...
        //2.设置mapper类和kv数据类型
        job.setMapperClass(NextMFMapper.class);
        ...
        //6.分组
        //7.设置mapper主类和kv数据类型
        job.setReducerClass(NextMFReducer.class);
